...
pub struct Block {
    ...
    pub jump: Option<Instr>,
}

impl Block {
    /// Adds a new instruction to the block
    pub fn add_instr(&mut self, instr: Instr) {
        self.items.push(Statement::Volatile(instr));
    }
    ...
    pub fn assign_instr(&mut self, temp: Value, ty: Type, instr: Instr) {
        ...
        self.items.push(Statement::Assign(temp, final_type, instr));
    }
